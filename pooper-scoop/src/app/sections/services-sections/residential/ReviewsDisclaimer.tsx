...
import Disclaimer from "./FreeCleanUp";
import DisclaimerBg from "@/components/disclaimer-bg";

export default function ReviewsDisclaimer() {
  return (
    <div className="customer-promise mx-auto w-full">
      <div className=" px-[20px] pb-90 relative">
        <DisclaimerBg />
        <div className="flex flex-col gap-20 max-sm:gap-10 pt-10">
          {/* <Reviews /> */}
          
    <div className="w-full">
      
        <div className="flex flex-col max-w-[var(--view-width)] mx-auto px-[20px] gap-[25px]">
          <div className="flex flex-col gap-4 py-14 py-10 px-[50px] bg-[#F8F8F8]/90 rounded-[var(--radius)]">
