        ...
        <div className="flex flex-row max-w-[var(--view-width)] mx-auto px-[20px] gap-[25px]">
          <div ref={ref} className="flex md:w-1/2 flex-col gap-y-4 py-14 py-10 px-[50px] bg-[#F8F8F8] rounded-[var(--radius)]">
            ...
            >
              ...
              <h2 className="h2 mb-3">Commercial Pet Waste Removal</h2>
            </div>
            ...
            <div>
              <ul className="flex flex-col gap-4 mb-[14px]">
                ...
                >
                  <CheckmarkIcon />
                  <span className="p">Free pet waste management plans for HOAs, apartments, and commercial properties.</span>
                </li>
                <li 
                  className={`flex items-start gap-3 transition-all duration-700 ${
                    isInView 
                ...
                >
                  <CheckmarkIcon />
                  <span className="p">Professional installation and maintenance of pet waste stations.</span>
                </li>
                <li 
                  className={`flex items-start gap-3 transition-all duration-700 ${
                    isInView 
                ...
                >
                  <CheckmarkIcon />
                  <span className="p">We pick up pet waste and remove garbage, ensuring a clean property.</span>
                </li>
              </ul>
            </div>
